...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector centernet_ros-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'centernet_ros-msg:BoundingBox :initial-element (cl:make-instance 'centernet_ros-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name centernet_ros-msg:<BoundingBoxes> is deprecated: use centernet_ros-msg:BoundingBoxes instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'centernet_ros-msg:BoundingBox))
