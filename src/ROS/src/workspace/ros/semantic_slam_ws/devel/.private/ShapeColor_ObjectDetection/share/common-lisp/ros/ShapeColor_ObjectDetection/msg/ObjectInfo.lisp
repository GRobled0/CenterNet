...
(cl:in-package ShapeColor_ObjectDetection-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ShapeColor_ObjectDetection-msg:<ObjectInfo> is deprecated: use ShapeColor_ObjectDetection-msg:ObjectInfo instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:type-val is deprecated.  Use ShapeColor_ObjectDetection-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'prob-val :lambda-list '(m))
(cl:defmethod prob-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:prob-val is deprecated.  Use ShapeColor_ObjectDetection-msg:prob instead.")
  (prob m))

(cl:ensure-generic-function 'tl_x-val :lambda-list '(m))
(cl:defmethod tl_x-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:tl_x-val is deprecated.  Use ShapeColor_ObjectDetection-msg:tl_x instead.")
  (tl_x m))

(cl:ensure-generic-function 'tl_y-val :lambda-list '(m))
(cl:defmethod tl_y-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:tl_y-val is deprecated.  Use ShapeColor_ObjectDetection-msg:tl_y instead.")
  (tl_y m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:width-val is deprecated.  Use ShapeColor_ObjectDetection-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:height-val is deprecated.  Use ShapeColor_ObjectDetection-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectInfo>)))
  ...
  "ShapeColor_ObjectDetection/ObjectInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectInfo)))
  "Returns string type for a message object of type 'ObjectInfo"
  "ShapeColor_ObjectDetection/ObjectInfo")
