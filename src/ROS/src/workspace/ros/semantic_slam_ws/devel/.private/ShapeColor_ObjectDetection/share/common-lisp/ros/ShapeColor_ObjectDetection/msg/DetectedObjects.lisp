...
(cl:defclass <DetectedObjects> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector ShapeColor_ObjectDetection-msg:ObjectInfo)
   :initform (cl:make-array 0 :element-type 'ShapeColor_ObjectDetection-msg:ObjectInfo :initial-element (cl:make-instance 'ShapeColor_ObjectDetection-msg:ObjectInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ShapeColor_ObjectDetection-msg:<DetectedObjects> is deprecated: use ShapeColor_ObjectDetection-msg:DetectedObjects instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DetectedObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:header-val is deprecated.  Use ShapeColor_ObjectDetection-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <DetectedObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ShapeColor_ObjectDetection-msg:objects-val is deprecated.  Use ShapeColor_ObjectDetection-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjects>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ShapeColor_ObjectDetection-msg:ObjectInfo))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObjects>)))
  ...
  "ShapeColor_ObjectDetection/DetectedObjects")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObjects)))
  "Returns string type for a message object of type 'DetectedObjects"
  "ShapeColor_ObjectDetection/DetectedObjects")
