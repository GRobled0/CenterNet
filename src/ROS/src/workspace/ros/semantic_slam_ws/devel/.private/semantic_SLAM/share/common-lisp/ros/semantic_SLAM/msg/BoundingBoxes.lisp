...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector semantic_SLAM-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'semantic_SLAM-msg:BoundingBox :initial-element (cl:make-instance 'semantic_SLAM-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name semantic_SLAM-msg:<BoundingBoxes> is deprecated: use semantic_SLAM-msg:BoundingBoxes instead.")))
...
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_SLAM-msg:bounding_boxes-val is deprecated.  Use semantic_SLAM-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'semantic_SLAM-msg:BoundingBox))
