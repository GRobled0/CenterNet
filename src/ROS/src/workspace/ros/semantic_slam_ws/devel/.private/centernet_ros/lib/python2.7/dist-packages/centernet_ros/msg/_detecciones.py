...
"""autogenerated by genpy from centernet_ros/detecciones.msg. Do not edit."""
import codecs
import sys
...
class detecciones(genpy.Message):
  ...
  _type = "centernet_ros/detecciones"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','centernet_ros/deteccion[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = centernet_ros.msg.deteccion()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
