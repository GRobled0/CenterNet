...
let BoundingBox2 = require('./BoundingBox2.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BoundingBoxes2 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.bounding_boxes.forEach((val) => {
      bufferOffset = BoundingBox2.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BoundingBoxes2(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.bounding_boxes[i] = BoundingBox2.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.bounding_boxes.forEach((val) => {
      length += BoundingBox2.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'centernet_ros/BoundingBoxes2';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: centernet_ros/BoundingBox2
    string Class
    float64 probability
    int64 xmin
    int64 ymin
  ...
  static Resolve(msg) {
    ...
    const resolved = new BoundingBoxes2(null);
    ...
    if (msg.bounding_boxes !== undefined) {
      ...
      for (let i = 0; i < resolved.bounding_boxes.length; ++i) {
        resolved.bounding_boxes[i] = BoundingBox2.Resolve(msg.bounding_boxes[i]);
      }
    }
    else {
