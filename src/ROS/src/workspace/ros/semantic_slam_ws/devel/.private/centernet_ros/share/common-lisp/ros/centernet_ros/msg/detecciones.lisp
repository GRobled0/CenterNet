...
(cl:defclass <detecciones> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector centernet_ros-msg:deteccion)
   :initform (cl:make-array 0 :element-type 'centernet_ros-msg:deteccion :initial-element (cl:make-instance 'centernet_ros-msg:deteccion))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <detecciones>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'detecciones)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name centernet_ros-msg:<detecciones> is deprecated: use centernet_ros-msg:detecciones instead.")))
...
(cl:defmethod data-val ((m <detecciones>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader centernet_ros-msg:data-val is deprecated.  Use centernet_ros-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <detecciones>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'centernet_ros-msg:deteccion))
