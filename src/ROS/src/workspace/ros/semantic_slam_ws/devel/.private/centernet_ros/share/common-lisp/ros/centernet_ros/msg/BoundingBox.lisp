...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name centernet_ros-msg:<BoundingBox> is deprecated: use centernet_ros-msg:BoundingBox instead.")))
