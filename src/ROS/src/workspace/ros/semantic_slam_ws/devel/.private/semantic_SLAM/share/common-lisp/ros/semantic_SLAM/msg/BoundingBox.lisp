...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name semantic_SLAM-msg:<BoundingBox> is deprecated: use semantic_SLAM-msg:BoundingBox instead.")))
...
(cl:defmethod depth-val ((m <BoundingBox>))
