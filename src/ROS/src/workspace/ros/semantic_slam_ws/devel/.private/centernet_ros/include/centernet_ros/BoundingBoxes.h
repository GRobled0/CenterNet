// Generated by gencpp from file centernet_ros/BoundingBoxes.msg
// DO NOT EDIT!
...
bool operator==(const ::centernet_ros::BoundingBoxes_<ContainerAllocator1> & lhs, const ::centernet_ros::BoundingBoxes_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::centernet_ros::BoundingBoxes_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::centernet_ros::BoundingBoxes_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::centernet_ros::BoundingBoxes_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::centernet_ros::BoundingBoxes_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::centernet_ros::BoundingBoxes_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::centernet_ros::BoundingBoxes_<ContainerAllocator> const>
  : TrueType
  { };
