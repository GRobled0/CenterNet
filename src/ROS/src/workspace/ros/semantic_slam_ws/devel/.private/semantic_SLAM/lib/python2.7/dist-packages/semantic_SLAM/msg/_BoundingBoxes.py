...
"""autogenerated by genpy from semantic_SLAM/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  ...
  _type = "semantic_SLAM/BoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','semantic_SLAM/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = semantic_SLAM.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
