...
"""autogenerated by genpy from centernet_ros/BoundingBooxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBooxes(genpy.Message):
  _md5sum = "37a46cf41c29ddce83a4a450ac620f6e"
  _type = "centernet_ros/BoundingBooxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','centernet_ros/BoundingBoox[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoundingBooxes, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = centernet_ros.msg.BoundingBoox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
