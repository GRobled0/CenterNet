// Generated by gencpp from file centernet_ros/BoundingBox.msg
// DO NOT EDIT!
...
bool operator==(const ::centernet_ros::BoundingBox_<ContainerAllocator1> & lhs, const ::centernet_ros::BoundingBox_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::centernet_ros::BoundingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::centernet_ros::BoundingBox_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::centernet_ros::BoundingBox_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::centernet_ros::BoundingBox_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::centernet_ros::BoundingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::centernet_ros::BoundingBox_<ContainerAllocator> const>
  : FalseType
  { };
