...
"""autogenerated by genpy from centernet_ros/BoundingBoxes2.msg. Do not edit."""
import codecs
import sys
...
import centernet_ros.msg
import std_msgs.msg

class BoundingBoxes2(genpy.Message):
  _md5sum = "37a46cf41c29ddce83a4a450ac620f6e"
  _type = "centernet_ros/BoundingBoxes2"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','centernet_ros/BoundingBox2[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoundingBoxes2, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = centernet_ros.msg.BoundingBox2()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
